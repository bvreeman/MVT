 // <input type="text" className="form-control" id="companyName" value="Minnesota Valley Transportation, Inc"></input>
            // <input type="text" className="form-control" id="companyAddress" value="301 Water St, New Ulm, MN"></input>
            // <div className='row'>
